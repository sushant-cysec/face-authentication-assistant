...
def wish():
    ...
    speak("i am sushant sir. please tell me how may i help you")
...
#for news updates
def news():
    main_url = 'http://newsapi.org/v2/top-headlines?sources=techcrunch&apiKey="5dff3b85f8a542bbad813c485700d3a7"'
...
if __name__ == "__main__": #main program
    ...
    while True:
        ...
        if "open notepad" in query:
            ...
            kit.sendwhatmsg("+91_7827730728", "this is testing protocol",4,13)
            time.sleep(120)
...
###########################################################################################################################################
            ...
            speak("thanks for using me sir,have a hood day.")
            sys.exit()
