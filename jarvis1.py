...
def screenshot():
    pyautogui.screenshot(f"C://Users//hp//Desktop//screenshot.png")
...
def command():
    ...
    try:
        ...
        if 'Jarvis' in query:
            ...
            webbrowser.open("https://www.google.com/maps/@28.6235458,77.4414451,16z")
            speak("Opening Maps...")
...
names = ['','sushant']  #names, leave first empty bcz counter starts from 0
